...
import com.example.finalminiproject.Contacts.CustomAdapter;
...
public class secondpage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emergenctbtn = findViewById(R.id.imageButton4);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (db.count() != 2) {
                    ...
                    Toast.makeText(secondpage.this, "Can't Add more than 2 Contacts", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
